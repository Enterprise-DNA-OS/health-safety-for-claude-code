...
Health and Safety for Claude Code does the job you pay ecoPortal for, as a Postgres database and a set of agent commands. There is no web front end. You open the folder in [Claude Code](https://claude.com/claude-code) (or Codex, OpenCode, Cursor: see `AGENTS.md`) and ask for what you want in plain language. It runs the right query, and it can answer questions the ecoPortal dashboard cannot.

<!-- TODO(author): the annual bill. One sentence: what a 10 to 50 person business typically pays ecoPortal per year, all in, with a source. -->
...
<!-- TODO(author): how to bring data across from ecoPortal; link docs/replace-ecoportal.md -->
...
Enterprise DNA installs Health and Safety for Claude Code for your business, migrates your ecoPortal data, connects it to the rest of your tools, and runs it for you as part of **Omni**, our managed Command Center. One setup fee, then a monthly retainer.
